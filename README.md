# Spring Boot Launcher for Windows Service
    ...
    <plugin>
        ...
        <configuration>
            ...
            <layoutFactory implementation="br.unesp.fc.spring.boot.loader.SpringLayoutFactory">
                <launcherClassName>spring_default</launcherClassName>
            </layoutFactory>
        </configuration>
        <executions>
            <execution>
...
The `launcherClassName` is the launcher class name. The special keyworkd `spring_default` is used to specify the default Spring launcher. To install it as service, run:
